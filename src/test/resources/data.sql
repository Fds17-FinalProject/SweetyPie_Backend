...
INSERT INTO reservation (id, `check_in_date`, `checkout_date`, `total_guest_num`, `adults`, `children`, `infants`, `is_canceled`, `is_written_review`,
                         `payment_date`, `total_price`, `accommodation_id`, `member_id`)
VALUES (1, '2022-02-10', '2022-02-12', '3', '2', '2', '0', 0, 1, '2022-03-01', 60000, 1, 1);

INSERT INTO reservation (id, `check_in_date`, `checkout_date`, `total_guest_num`, `adults`, `children`, `infants`, `is_canceled`, `is_written_review`,
                         `payment_date`, `total_price`, `accommodation_id`, `member_id`)
VALUES (2, '2022-02-20', '2022-02-22', '3', '2', '3', '1', 0, 0, '2022-03-03', 120000, 1, 1);
