...
class AccommodationControllerTest {
    ...
    void getAccommodation() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/accommodation/1"))
                ...
                .andExpect(jsonPath("$.accommodationPictures[0].url").value("https://a0.muscache.com/pictures/417af44b-df9d-4915-903a-05f3e7370305.jpg"));
    ...
    void getAccommodationsBySearchKeyword() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/accommodations/search/서울?page=0"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.content[0].city").value("서울특별시"));
    }
